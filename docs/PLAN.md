...
> **STATUS (2026-06-13): Step 6 (relevance lab: measurement) COMPLETE, merged to main and tagged v0.6. nDCG@10/MRR/recall harness over 480 WANDS queries + 231,873 judgments, persisted runs, Studio relevance lab (runs list, worst-queries, compare). Verified baseline: nDCG@10 0.6532, MRR 0.8701, recall@100 37.5%. Teaching HTML + interview bank done. NEXT: Step 7 (relevance lab: tuning) — field-boost sliders with instant re-eval, function_score popularity signals, _explain visualizer, train/test split, graduate-config-to-shop. Beat the 0.6532 baseline.**
